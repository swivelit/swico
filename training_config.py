...
SUPPORTED_ENV_KEYS = frozenset(
    {
        ...
        "SWICO_QWEN_ENV_FILE",
        "SWICO_QWEN_PROFILE",
        "SWICO_QWEN_DATA_PATH",
        "SWICO_QWEN_BASE_MODEL",
        "SWICO_QWEN_OUTPUT_ROOT",
        "SWICO_QWEN_OUTPUT_DIR",
        "SWICO_QWEN_RUN_MODE",
        "SWICO_QWEN_RUN_LABEL",
        "SWICO_QWEN_CREATE_LATEST_LINKS",
        "SWICO_QWEN_CPU_THREADS",
        "SWICO_QWEN_SEED",
        "SWICO_QWEN_BF16",
        "SWICO_QWEN_OFFLINE",
        "SWICO_QWEN_RESUME",
        "SWICO_QWEN_PREPARE_ONLY",
        "SWICO_QWEN_MAX_CONVERSATIONS",
        "SWICO_QWEN_TRAIN_SPLIT_FRACTION",
        "SWICO_QWEN_VALIDATION_SPLIT_FRACTION",
        "SWICO_QWEN_TEST_SPLIT_FRACTION",
        "SWICO_QWEN_MAX_SEQ_LENGTH",
        "SWICO_QWEN_EPOCHS",
        "SWICO_QWEN_BATCH_SIZE",
        "SWICO_QWEN_EVAL_BATCH_SIZE",
        "SWICO_QWEN_GRADIENT_ACCUMULATION_STEPS",
        "SWICO_QWEN_LEARNING_RATE",
        "SWICO_QWEN_WEIGHT_DECAY",
        "SWICO_QWEN_WARMUP_RATIO",
        "SWICO_QWEN_LR_SCHEDULER_TYPE",
        "SWICO_QWEN_MAX_GRAD_NORM",
        "SWICO_QWEN_GRADIENT_CHECKPOINTING",
        "SWICO_QWEN_LOGGING_STEPS",
        "SWICO_QWEN_SAVE_TOTAL_LIMIT",
        "SWICO_QWEN_EVAL_STEPS",
        "SWICO_QWEN_SAVE_STEPS",
        "SWICO_QWEN_DATALOADER_NUM_WORKERS",
        "SWICO_QWEN_LORA_R",
        "SWICO_QWEN_LORA_ALPHA",
        "SWICO_QWEN_LORA_DROPOUT",
        "SWICO_QWEN_LORA_TARGET_MODULES",
        "SWICO_QWEN_EARLY_STOPPING",
        "SWICO_QWEN_EARLY_STOPPING_PATIENCE",
        "SWICO_QWEN_EARLY_STOPPING_THRESHOLD",
        "SWICO_QWEN_LOAD_BEST_MODEL_AT_END",
        ...
        "SWICO_QWEN_FROZEN_EVAL_IDS",
        "SWICO_QWEN_MEMORY_GUARD",
        "SWICO_QWEN_MEMORY_GUARD_INTERVAL_STEPS",
        "SWICO_QWEN_EMERGENCY_AVAILABLE_MEMORY_GIB",
        "SWICO_QWEN_MAX_PROCESS_RSS_GIB",
        "SWICO_QWEN_MIN_AVAILABLE_MEMORY_GIB",
        "SWICO_QWEN_MIN_FREE_DISK_GIB",
    }
)
